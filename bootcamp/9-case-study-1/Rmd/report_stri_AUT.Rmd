...
```{r fig0, echo=FALSE, message=FALSE}
...
```{r fig1, fig.path="figures/report_stri/AUT/", fig.height=9, fig.width=10, echo=FALSE, message=FALSE}
...
```{r fig2, fig.path="figures/report_stri/AUT/", fig.height=5, fig.width=10, echo=FALSE, message=FALSE}

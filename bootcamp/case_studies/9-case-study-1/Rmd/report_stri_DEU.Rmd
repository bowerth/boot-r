...
```{r fig1, fig.path="figures/report_stri/DEU/", fig.height=9, fig.width=10, echo=FALSE, message=FALSE}
...
```{r fig2, fig.path="figures/report_stri/DEU/", fig.height=5, fig.width=10, echo=FALSE, message=FALSE}
